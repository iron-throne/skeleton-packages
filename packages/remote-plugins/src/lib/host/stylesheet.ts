import type { IRemotePluginManifest } from "../types";
...
export const ensurePluginStylesheet = (manifest: IRemotePluginManifest): void => {
    const href = manifest.entryUrl.replace(/\.js$/, '.css');
