<script lang="ts">
	...
	const groups: ComponentGroup[] = [
		...
		},
		{
			...
			items: [
				{ name: 'Accordion', description: 'Expandable content sections and variants.' },
				{ name: 'Card', description: 'Flexible content and project card layouts.', href: '/card' },
				{ name: 'Combobox', description: 'Combined text input and option selection.' },
				{ name: 'Date Picker', description: 'Calendar-based date selection.' },
				{ name: 'Form', description: 'Structured form composition and submission.' },
				{ name: 'Loader', description: 'Application loading indicator.', href: '/loader' },
				{ name: 'Snackbar', description: 'Timed application notifications.' },
				{ name: 'OTP Input', description: 'Multi-cell verification code input.' },
				{ name: 'Rating', description: 'Interactive score and rating control.' }
			]
		},
		{
			id: 'organisms',
			...
			items: [
				{ name: 'Breadcrumb', description: 'Hierarchical page navigation.' },
				{
					name: 'Advanced Table',
				...
				{ name: 'Chart', description: 'Reusable data visualization wrapper.' },
				{
					name: 'Data Table',
