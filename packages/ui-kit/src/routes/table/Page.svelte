<script lang="ts">
	...
	import DocumentTable from '$atoms/document-table/DocumentTable.svelte';
	import AdvancedTable from '$organisms/advanced-table/AdvancedTable.svelte';
	import { ESize } from '@aryagg/types';
	import type { AdvancedTableColumn, AdvancedTableRow } from '$organisms/advanced-table/types';
	import {
